...
const Register = () => {
  const [translation] = useTranslation(PAGE_KEY.REGISTER_PAGE)
  ...
  const handleLogin = async (values: UserForm) => {
      ...
      >
        <CardContent>
          ...
          <Stack direction="row" justifyContent="center" alignItems="center" gap={1}>
            <Typography variant="body1">{translation('indicators.withAccount')}</Typography>

            <Button component={Link} to={ROUTE_CONFIG.LOGIN} sx={{ textTransform: 'capitalize' }}>
